...
com.clipomatiq.daylife.DayLifeData,com.clipomatiq.ClipomatiqInside, com.clipomatiq.daylife.DaylifeArticle;"%>
...
<%	
 ...
 <% 
 	try{
 	DayLifeData dld=ClipomatiqInside.daylifeProcess(gName); 
 	ArrayList articles=dld.getEntries();
 	DaylifeArticle article;
 	for(int j=0;j<articles.size();j++){
		article=(DaylifeArticle)articles.get(j);
		if(article.getArticle_id()==null)continue;
 	%>
 	<div id="newsblock">
 	<h4><%=article.getHeadline() %></h4>
 	<p>
   			<%=article.getExcerpt()%> 
	</p>
	<a href="<%=article.getDaylife_url()%>"> more..</a>
...
<p id="copy"> &copy;2008  <a href="mailto:adm@clipomatiq.hostignition.com">mdmn</a></p>
<ul >
